...
$("#submit-route").on("click", function(event) {
    ...
    $("#first-train").val("");
    $("#frequency").val("");
    console.log("Train Name "+fTrainName);
    console.log("Destination "+fDestination);
    console.log("First Train "+fFirstTrain);
    console.log("Frequency "+fFrequency);
